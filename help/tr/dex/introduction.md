...
Merkezsiz borsa (kısaca *DEX*) , Evolution ekosisteminde 
...
Bunlardan kısaca bahsetmek istiyoruz. Evolution DEX'de hepsi mevcut olmasina 
...
* **Güçler Ayrılığı** : 
  ...
  kimsenin sorumlu olmasını gerektirecek bir sebep yoktur. Evolution'de işlem 
...
* **Genel Birleşik Emir/Sipariş Defteri** :
  Evolution evrensel olduğu için , internet erişimi olan herkes  DEX'i alım-satım için 
...
* **Neredeyse Herşeyi Alıp-Satabilirsiniz** :
  Evolution DEX varlığın muhteviyatını bilmez , dolayısı ile **her türlü**  eşleşme ticareti 
...
* **Limit Yok** :
  Evolution protokolünün sizin ticaret deneyiminizi sınırlaması mümkün değildir.
* **Merkezsiz** :
  DEX (merkezsiz borsa) tüm dünyaya dağıtıktır. Bölece tek kırılma noktası 
  olmadığı gibi bu Evolution borsasının ticaret için 7/24 açık olduğu anlamına 
...
* **Hızlı** :
  Diğer merkezsiz ağların tersine Evolution DEX gerçek-zamanlı ticarete
   imkan tanır , sadece ışık hızı ve gezegenin büyüklüğü 
  ile sınırlıdır.
* **Kanıtlanabilir Emir Eşleştirme Algoritması** :
  Evolution DEX i nadir kılan şeylerden biri de ispatlanabilir emir eşleştirme 
...
* **Teminata Bağlanmış** :
  Evolution'in en büyük özelliklerinden biri de bitUSD, bitEUR, bitCNY gibi 
  *akıllıparalar*dır. Kolaylık olsun diye bu varlıklar cüzdan içerisinde USD,EUR,CNY 
  ...
  fiyatında hesap görümü için mevcut olabilen, **Evolution'in şirket hisseleri (EVO)** 
   vardır.