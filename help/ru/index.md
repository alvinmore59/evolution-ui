...
Evolution 2.0 - это платформа Финансовых Смарт-Контрактов, постороенная на технологии [Evolution](https://github.com/cryptonomex/evolution), созданной [Cryptonomex](http://cryptonomex.com). Evolution можно рассматривать как набор инструментов или технологию для создания блокчейнов работающих в режиме реального времени.
...
- [Делегаты](introduction/delegate.md)
