...
const EVOLUTION_100_PERCENT = 10000;
...
/**
    * @brief The price struct stores asset prices in the Evolution system.
    *
    ...
    * normal.
    *
    * The assets within a price are labeled base and quote. Throughout the Evolution code base, the convention used is
...
class CallOrder {
    constructor(order, assets, market_base, feed, is_prediction_market = false) {
        ...
        * done by the delegate_node before returning the orders so it is not necessary
    ...
    /*
    * Assume a USD:EVO market
    * The call order will always be selling EVO in order to buy USD
...
class SettleOrder extends LimitOrder {
    ...
    amountToReceive() {
        ...
        to_receive.setAmount({sats: to_receive.getAmount() * ((EVOLUTION_100_PERCENT - this.offset_percent) / EVOLUTION_100_PERCENT) });
