...
const CORE_ASSET = "EVO"; // Setting this to EVO to prevent loading issues when used with EVO chain which is the most usual case currently
...
class SettingsStore {
    ...
    init() {
        return new Promise((resolve) => {
            ...
            let coreAssets = {markets_3d2fd4dd: "EVO"};
            let coreAsset = coreAssets[this.starredKey] || "EVO";
            this.defaults.unit[0] = coreAsset;

            let chainBases = bases[this.starredKey] || bases.markets_3d2fd4dd;
