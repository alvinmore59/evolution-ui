...
import {ChainStore, ChainTypes as evolutionChainTypes} from "evolution-js/es";
    ...
    render() {
        ...
        switch (ops[op[0]]) { // For a list of trx types, see chain_types.coffee
            ...
            case "delegate_create":
                column = (
                    <span>
                        <Translate component="span" content="proposal.delegate_create" />
            ...
            case "delegate_update":
                column = (
                    <span>
                        <Translate component="span" content="proposal.delegate_update" />
                        &nbsp;{this.linkToAccount(op[1].delegate_account)}
                    </span>
                );
            ...
            case "delegate_withdraw_pay":
                if (current === op[1].delegate_account) {
                    column = (
                        <span>
                            <Translate component="span" content="proposal.delegate_pay" />
                            &nbsp;<FormattedAsset style={{fontWeight: "bold"}} amount={op[1].amount} asset={"1.3.0"} />
                            <Translate component="span" content="proposal.to" />
                            &nbsp;{this.linkToAccount(op[1].delegate_account)}
                        </span>
