...
import {PrivateKey, Aes, PublicKey, hash} from "evolution-js/es";
import {ChainConfig} from "evolution-ws";
...
class ImportKeys extends Component {
    ...
    /** EVO 1.0 client wallet_export_keys format. */
    _parseImportKeyUpload(json_contents, file_name, update_state) {
        ...
        // EVO 1.0 wallets may have a lot of generated but unused keys or spent TITAN addresses making
    ...
    /**
    EVO 1.0 hosted wallet backup (wallet.evolution.org) is supported.

    EVO 1.0 native wallets should use wallet_export_keys instead of a wallet backup.
    ...
    */
    _parseWalletJson(json_contents) {
        ...
        let savePubkeyAccount = function (pubkey, account_name) {
            ...
            address = "EVO" + address.substring(3);
        ...
        try {
            ...
            if( ! encrypted_brainkey)
                throw "Please use a EVO 1.0 wallet_export_keys file instead";
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <form onSubmit={this._passwordCheck.bind(this)}>
                                <label><Translate content="wallet.evo_09_export" />
