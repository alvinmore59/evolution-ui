...
class SimpleDepositBlocktradesBridge extends React.Component {
    ...
    _renderDeposit() {
        ...
        let price = receiveName === "EVO" && inputName === "BTC" ? (this.state.inputAmount / this.state.receiveAmount).toFixed(8) :
            (this.state.receiveAmount / this.state.inputAmount).toFixed(4);
        let priceSuffix = receiveName === "EVO" && inputName === "BTC" ? inputName +"/" + receiveName :
