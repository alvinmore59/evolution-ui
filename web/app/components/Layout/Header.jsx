...
class Header extends React.Component {
    ...
    render() {
        ...
        let tradeLink = this.props.lastMarket && active.indexOf("market/") === -1 ?
            ...
            <a className={cnames({active: active.indexOf("market/") !== -1})} onClick={this._onNavigate.bind(this, "/market/USD_EVO")}><Translate component="span" content="header.exchange" /></a>;
