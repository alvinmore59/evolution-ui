...
import {ChainStore, ChainValidation} from "evolution-js/es";
        ...
        return (
            <div className="small-12 grid-content">
                ...
                <label><Translate content="account.user_issued_assets.force_settlement_offset_percent" />
                    <input type="number" value={bitasset_opts.force_settlement_offset_percent / assetConstants.EVOLUTION_1_PERCENT} onChange={this.props.onUpdate.bind(this, "force_settlement_offset_percent")}/>
                </label>

                <label><Translate content="account.user_issued_assets.maximum_force_settlement_volume" />
                    <input type="number" value={bitasset_opts.maximum_force_settlement_volume / assetConstants.EVOLUTION_1_PERCENT} onChange={this.props.onUpdate.bind(this, "maximum_force_settlement_volume")}/>
                </label>
    ...
    resetState(props) {
        ...
        return {
            ...
            bitasset_opts: {
                ...
                "force_settlement_offset_percent" : 1 * assetConstants.EVOLUTION_1_PERCENT,
                "maximum_force_settlement_volume" : 20 * assetConstants.EVOLUTION_1_PERCENT,
    ...
    onChangeBitAssetOpts(value, e) {
        ...
        switch (value) {
            ...
            case "maximum_force_settlement_volume":
                bitasset_opts[value] = parseFloat(e.target.value) * assetConstants.EVOLUTION_1_PERCENT;
                break;
