...
function getDelegateOrCommittee(type, acct) {
...
class AccountItemRow extends React.Component {
    ...
    render() {
        ...
        let {url, votes} = getDelegateOrCommittee(type, account);
...
class AccountsList extends React.Component {
    ...
    render() {
        ...
        .sort((a,b) =>{
            let {votes: a_votes} = getDelegateOrCommittee(this.props.type, a);
            let {votes: b_votes} = getDelegateOrCommittee(this.props.type, b);
            if (a_votes !== b_votes) {
