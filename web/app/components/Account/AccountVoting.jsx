...
import {ChainStore, FetchChainObjects} from "evolution-js/es";
...
class AccountVoting extends React.Component {
    ...
    onPublish() {
        ...
        new_options.num_delegate = this.state.delegates.size;
        ...
        FetchChainObjects(ChainStore.getDelegateById, this.state.delegates.toArray(), 4000).then( res => {
            ...
            return Promise.all([Promise.resolve(delegates_vote_ids), FetchChainObjects(ChainStore.getCommitteeMemberById, this.state.committee.toArray(), 4000)]);
        }).then( res => {
