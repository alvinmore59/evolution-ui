...
import {ChainTypes as evolutionChainTypes} from "evolution-js/es";
import TransitionWrapper from "../Utility/TransitionWrapper";
import ps from "perfect-scrollbar";
import counterpart from "counterpart";

const {operations} = evolutionChainTypes;
...
class RecentTransactions extends React.Component {
    ...
    componentDidUpdate() {
        if (this.state.csvExport) {
            ...
            var today = new Date();
            saveAs(blob, "evohist-" + today.getFullYear() + "-" + today.getMonth() + "-" + today.getDate() + ".csv");
        }
                    ...
                    <div ref="header">
                        ...
                        <div className="block-content-header">
                            ...
                            <div className="float-right">
                                <select data-place="left" data-tip={counterpart.translate("tooltip.filter_ops")} style={{paddingTop: 0}} className="evo-select" value={this.state.filter} onChange={this._onChangeFilter.bind(this)}>{options}</select>
                            </div>) : null}
                        </div>
