            ...
            template: (
                <div>
                        <div className="content-block">
                            ...
                            <div className="service-selector">
                                <ul className="button-group segmented no-margin">
                                    <li onClick={this.toggleEVOervice.bind(this, "bridge")} className={btService === "bridge" ? "is-active" : ""}><a><Translate content="gateway.bridge" /></a></li>
                                    <li onClick={this.toggleEVOervice.bind(this, "gateway")} className={btService === "gateway" ? "is-active" : ""}><a><Translate content="gateway.gateway" /></a></li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <p>Openledger's gateway continues to operate, and it offers more coins and a far more liquid trading environment. Note that we will be continuing the operation of our cryptocurrency bridge for quickly buying and selling cryptocurrency, since it is actively used by the Evolution community.</p>
                    ...
                    <div>
                        <div className="grid-block vertical medium-horizontal no-margin no-padding">
                            <div className="medium-6 small-order-2 medium-order-1">
                                ...
                                <select onChange={this.onSetService.bind(this)} className="evo-select" value={activeService} >
                                    {options}
                                </select>
                            </div>
...
class DepositStoreWrapper extends React.Component {
    ...
    componentWillMount() {
        if (Apis.instance().chain_id.substr(0, 8) === "3d2fd4dd") { // Only fetch this when on EVO main net
