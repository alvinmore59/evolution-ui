...
module.exports = function(env) {
    ...
    var plugins = [
        ...
        new webpack.DefinePlugin({
            ...
            __UI_API__: JSON.stringify(env.apiUrl || "https://ui.evolution.eu/api"),
    ...
    var config = {
        entry: {
            // vendor: ["react", "react-dom", "highcharts/highstock", "evolution-js", "lodash"],
            app: env.prod ?
        ...
        module: {
            rules: [
                {
                    test: /\.jsx$/,
                    include: [path.join(root_dir, "app"), path.join(root_dir, "node_modules/react-foundation-apps"), "/home/sigve/Dev/evolution/react-foundation-apps"],
                    use: [
                        {
                            loader: "babel-loader",
                            options: {
